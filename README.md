...
- **Menú y productos**: categorías, productos, variantes (tamaños), grupos de modificadores/adicionales (obligatorios u opcionales, con mínimos y máximos), estaciones de preparación (cocina, barra, postres, etc.), activar/desactivar productos. Se puede cargar todo de una vez importando un Excel/CSV de Fudo u otro sistema (ver Novedades de la Fase 4).
